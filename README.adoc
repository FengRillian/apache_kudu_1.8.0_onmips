...
depend softwares: nss  node  nodejs  flex  cmake  gcc-c++  openssl-devel
...
While have a file error that cannot be found in mm_malloc.h, create the directory apache-kudu-1.8.0/thirdparty/installed/tmpclang_include/clang/6.0.0/include/.
